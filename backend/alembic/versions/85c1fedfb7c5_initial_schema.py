...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("nome", sa.String(200), nullable=False),
        sa.Column(postgresql.ENUM("fabrica", "centro_distribuicao", "escritorio", name="tipounidade", create_type=False), name="tipo", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(postgresql.ENUM("admin", "gerente", "operador", "visualizador", name="roleusuario", create_type=False), name="role", nullable=False),
        sa.Column("telefone", sa.String(20), nullable=True),
